<!--==========================
  ...
  <footer id="footer">
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <!-- <img src="images/biid.png" class="img-fluid" style="margin-bottom: 10px;"> -->
          <h1>UNMC</h1>
          <?php echo $cfg_footer_content;?>
          <div class="socials">
        ...
        <div class="col-md-4">
          <h4>Latest News</h4>
          <div class="links">
            <a href="#">The Ordinary Extra</a>
            <a href="#">Speaking From The Heart</a>
            <a href="#">Extra-Ordinary, The Extra</a>
          </div>
        </div>
