...
if (isset($_POST['submit'])) {
	if (isset($_POST['yes'])) {
		$msg = "<script>location.href = 'ques5.php';</script>";
	}elseif (isset($_POST['no'])) {
		$msg = "<script type='text/javascript'>
            swal({
            	title:\"Sorry!\",
            	text:\"This movement is for NIGERIANS who want to pursue a positive change for NIGERIA!\", 
            	type:\"error\",
            	timer: 2000,
				...
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							...
							<h3 class="card-title text-center">Do you agree that Nigeria need to pursue a new direction?</h3>
